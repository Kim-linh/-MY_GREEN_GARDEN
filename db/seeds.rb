...
kentia = Plant.create!(days: 4, variety: "Kentia", description:"Je suis la plante parfaite pour apporter une touche luxuriantequelle pour ton intérieur.", origin: "Je viens d'une province à l'ouest de l'Australie", maintenance: "N’hésitez pas à m’arroser une à deux fois par semaine au printemps et en été. J'apprécie une exposition lumineuse, à l’abri des rayons directs du soleil. ", category: "Plante exotique, plante à feuillage décoratif", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227535/kentia_oatnuc.jpg")
ficus = Plant.create!(days: 8, variety: "Ficus", description:"Je suis la plante incontournable de toute jungle d’intérieur digne de ce nom.", origin: "Je viens de l'Océan Indien.", maintenance: "N’hésitez pas à m’arroser une fois par semaine en été et un peu moins fréquemment en hiver. Trouvez-moi une petite place à la lumière. Je suis casanié, je n'aime donc pas que l'on me change de place. ", category: " Plante arbustive", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227523/ficus_dt4mgs.jpg")
amstelking = Plant.create!(days: 9, variety: "Ficus Amstel King", description:"Je suis la cousine du Ficus et toujours incontournable de toute jungle d’intérieur digne de ce nom.",origin: "Je suis originaire de l'Océan Indien.", maintenance: "Il faut que tu m'arroses une fois par semaine en été et un peu moins fréquemment en hiver. J'adore la lumière et je suis casanié, je n'aime donc pas que l'on me change de place. ", category: " Plante arbustive", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227526/amstelking_jxfhqe.jpg")
palmier = Plant.create!(days: 3, variety: "Palmier", description: "Je diffuse une atmosphère estivale dans ton salon, quelle que soit la saison.", origin: "Je viens d'Afrique.", maintenance: "Au printemps et en été, arrosez moi une à deux fois parsemaine. Le reste de l’année, réduisez les arrosages. ", category: "Plante exotique, plante à feuillage décoratif", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559145865/palmier_f2xykh.jpg" )
