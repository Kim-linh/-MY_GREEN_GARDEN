...
kentia = Plant.create!(days: 4, variety: "Kentia", description:"Sans me vanter, je suis la plante parfaite pour apporter une touche luxuriantequelle pour ton intérieur.", origin: "Je viens d'une province à l'ouest de l'Australie", maintenance: "N’hésitez pas à m’arroser une à deux fois par semaine au printemps et en été. J'apprécie une exposition lumineuse, à l’abri des rayons directs du soleil. ", category: "Palmiers", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227535/kentia_oatnuc.jpg")
...
palmier = Plant.create!(days: 3, variety: "Palmier", description: "Je diffuse une atmosphère estivale dans ton salon, quelle que soit la saison.", origin: "Je viens d'Afrique", maintenance: "Au printemps et en été, arrosez moi une à deux fois parsemaine. Le reste de l’année, réduisez les arrosages. ", category: "Palmier", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559145865/palmier_f2xykh.jpg" )
