...
cactus = Plant.create!(days: 17, variety: "Cactus", description:"Je ne manque pas d’apporter une belle dose de piquant à votre quotidien.", origin: "Je viens d'Afrique.", maintenance: "Arrosez-moi 1 à 2 fois par mois en été et peu ou pas en hiver. Les apports en eau doivent être très légers.", category: "Plante à fleurs, plante grasse.", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559145855/cactus_pazkyu.jpg")
yucca = Plant.create!(days: 7 , variety: "Yucca", description: "Je suis une plante vivaces arbustive remarquable par mes rosettes de feuilles dures.", origin: "Je viens d'Europe du Sud et des Antilles", maintenance: "Arrosez-moi 1 fois par semaine en été et en hiver.", category: "Plantes vivaces arbustives", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559145860/yucca_wboju0.jpg")
calathea = Plant.create!(days: 3 , variety: "Calathea Médaillon", description:"J'ai besoin d'un peu d'attention pour m'épanouir.", origin: "Je viens d'une province d'Amérique du Sud", maintenance: "N’hésitez pas à m’arroser plusieurs fois par semaine au printemps et en été de façon à garder ma terre légèrement humide. Je ne supporte pas le plein soleil.", category: "Plantes herbacées", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227540/calathea_yskoen.jpg")
kentia = Plant.create!(days: 4, variety: "Kentia", description:"Je suis la plante parfaite pour apporter une touche luxuriantequelle pour votre intérieur.", origin: "Je viens d'une province à l'ouest de l'Australie", maintenance: "N’hésitez pas à m’arroser une à deux fois par semaine au printemps et en été. J'apprécie une exposition lumineuse, à l’abri des rayons directs du soleil. ", category: "Palmiers", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227535/kentia_oatnuc.jpg")
ficus = Plant.create!(days: 8, variety: "Ficus", description:"Je suis la plante incontournable de toute jungle d’intérieur digne de ce nom.", origin: "Je viens de l'Ocean Indien", maintenance: "N’hésitez pas à m’arroser une fois par semaine en été et un peu moins fréquemment en hiver. Trouvez-moi une petite place à la lumière. Je suis casanié, je n'aime donc pas que l'on me change de place. ", category: " Moraceae", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227523/ficus_dt4mgs.jpg")
amstelking = Plant.create!(days: 9, variety: "Ficus Amstel King", description:"Je suis la cousine du Ficus et toujours incontournable de toute jungle d’intérieur digne de ce nom.",origin: "Je viens de l'Ocean Indien", maintenance: "N’hésitez pas à m’arroser une fois par semaine en été et un peu moins fréquemment en hiver. Trouvez-moi une petite place à la lumière. Je suis casanié, je n'aime donc pas que l'on me change de place. ", category: " Moraceae", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227526/amstelking_jxfhqe.jpg")
palmier = Plant.create!(days: 3, variety: "Palmier", description: "Je diffuse une atmosphère estivale dans votre salon, quelle que soit la saison.", origin: "Je viens d'Afrique", maintenance: "Au printemps et en été, arrosez moi une à deux fois parsemaine. Le reste de l’année, réduisez les arrosages. ", category: "Palmier", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559145865/palmier_f2xykh.jpg" )
pilea = Plant.create!(days: 5, variety: "Pilea", description: "Également connue sous le nom de Plante à monnaie chinoise, je suis une star végétale !", origin: "Je suis originaire d'une province Chinoise.", maintenance: "J'adore les endroits lumineux mais il faut que tu évites de m'exposer aux rayons du soleil. J'ai besoin d'être arrosé environ 2 fois par semaine en été, et une fois par semaine en hiver. L'arrosage doit se faire sans excès pour ne pas inonder mes racines. Il faut également me rempoter à chaque printemps pour que je puisse m'épanouir pleinement.", category: "Plante à fleurs", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559225343/pilea_gtrxpr.jpg")
