...
kentia = Plant.create!(days: 4, variety: "Kentia", description:"Je suis la plante parfaite pour apporter une touche luxuriante pour ton intérieur.", origin: "Je viens d'une province à l'ouest de l'Australie", maintenance: "J'aime être arrosée 1 à 2 fois par semaine au printemps et en été. J'apprécie une exposition lumineuse, à l’abri des rayons directs du soleil. ", category: "Plante exotique, plante à feuillage décoratif", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559227535/kentia_oatnuc.jpg")
...
hoya = Plant.create!(days: 2, variety: "Hoya", description: "Je suis une plante au charme renversant, aussi belle suspendue dans les airs que posée sur une de tes étagères.", origin: "Je suis originaire d'Extrême-Orient et d'Austalie tropicale", maintenance: "Il faut me chouchouter en m'offrant une belle place à la lumière sans soleil direct et en me préservant des coups de chaud. Je bois beaucoup d'eau, au moins 3 fois par semaine. Il faut que tu penses à laisser la terre sécher entre chaque apport d'eau.", category: "Plante à fleurs, plante tropicale, plante grimpante", picture: "https://res.cloudinary.com/kimlinh/image/upload/v1559225350/hoya_ipq86u.jpg")
...
user_plant2 = UserPlant.new(name: "Bob", origin_health: 4, remote_picture_url: "https://res.cloudinary.com/kimlinh/image/upload/v1559746090/plant_5_c9ekqr.jpg")
user_plant2.user = moranne
user_plant2.plant = yucca
user_plant2.save!

user_plant3 = UserPlant.new(name: "Kiki", origin_health: 2, remote_picture_url: "https://res.cloudinary.com/kimlinh/image/upload/v1559742221/plant2_sbqxeq.jpg")
...
user_plant6 = UserPlant.new(name: "Duncan", origin_health: 4, remote_picture_url: "https://mediasv6.truffaut.com/Articles/jpg/0592000/592581_002_1000.jpg")
